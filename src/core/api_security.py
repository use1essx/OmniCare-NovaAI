...
Handles secure API key management and prevents exposure for AWS Bedrock
"""
...
def log_api_operation(operation: str, success: bool, details: Optional[str] = None) -> None:
    """
