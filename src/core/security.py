...
class PasswordValidator:
    ...
    def validate(self, password: str, user_info: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
...
class PasswordHasher:
    ...
    def needs_update(self, hashed_password: str) -> bool:
        """Check if password hash needs updating (e.g., different rounds)"""
        try:
            ...
            return True  # Unknown format, should update
        except Exception:
            return True
...
class IPValidator:
    ...
    @classmethod
    def validate_ip(cls, ip_str: str) -> Dict[str, Any]:
        """
